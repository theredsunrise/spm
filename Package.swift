...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "sam", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/sam/9.3.0/Sam.zip", checksum: "caffd31c1"),
        .binaryTarget(name: "iface", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/iface/9.0.3/IFace.zip", checksum: "df0df379"),
        .binaryTarget(name: "onnxruntime", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/onnx/9.0.3/Onnx.zip", checksum: "8c59"),
        .binaryTarget(name: "DotProtocolBuffers", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/dot-protobuf/9.0.0/DotProtocolBuffers.zip", checksum: "51e9564"),
        .binaryTarget(name: "OpenSSL", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/dot-openssl/9.1.0/OpenSSL.zip", checksum: "c241"),
        .binaryTarget(name: "SamFace", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/sam-face/9.2.0/SamFace.zip", checksum: "a309d6"),
        .binaryTarget(name: "DotCore", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/dot-core/9.1.0/DotCore.zip", checksum: "b74"),
        .binaryTarget(name: "DotCamera", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/dot-camera/9.1.0/DotCamera.zip", checksum: "ca74f"),
        ...
        .binaryTarget(name: "DotFaceLite", url: "https://s3.eu-central-1.amazonaws.com/ios-frameworks.innovatrics.com/dot-face-lite/9.1.0/DotFaceLite.zip", checksum: "34249a709549b7fc68d876b71572bce5938201e240265a942795e2a3171be04a"),
